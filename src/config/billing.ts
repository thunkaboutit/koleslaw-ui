/* Stripe URLs are public (they ship in the bundle regardless).
   LIVE-MODE values since the 2026-08-03 live flip
   (workspace docs/stripe-billing-plan.md, Phase E). */

// Payment Link for Koleslaw Pro ($10/mo).
export const PRO_PAYMENT_LINK_URL = 'https://buy.stripe.com/28E28ldis67g9htc2AbII00'

// No-code Stripe Customer Portal login (email magic-link auth).
export const BILLING_PORTAL_LOGIN_URL =
  'https://billing.stripe.com/p/login/eVqfZbbakcvE51d1nWbII01'
